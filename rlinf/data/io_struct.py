...
class EmbodiedRolloutResult:
    ...
    def to_dict(self):
        ...
        ), f"dones length (len(rollout_result_dict['dones']))={len(rollout_result_dict['dones'])} must be the length of rewards (len(rollout_result_dict['rewards']))={len(rollout_result_dict['rewards'])} plus rollout_epoch ({self.rollout_epoch})"
